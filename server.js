...
const app_id = '1972036449679547';
const app_secret = '3c7d99fd691741b388279a1a59011aad';
...
function loadLogin() {
  return fs.readFileSync('src/app/components/common/login/login.html').toString();
}
